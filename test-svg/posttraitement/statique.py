...
def go(input_file, output_prefix, parameters=None):
    ...
    while(zoneRougeTrouve==0):
        ...
        while(posgxr+pas<width):
            if(color[0]==221 and color[1]==0 and color[2]==0):
                zoneRougeTrouve=1
                break
            posgxr=posgxr+pas
            color= pix[posgxr,posyr]
    ...
    poshyr=posyr
    while(color[0]==221 and color[1]==0 and color[2]==0 and poshyr-pas>0):
        poshyr=poshyr-pas
    ...
    while(color[0]==221 and color[1]==0 and color[2]==0 and posbyr+pas<height):
        posbyr=posbyr+pas
        color= pix[posgxr,posbyr]
    posbyr=posbyr-pas   
    ...
    posdxr=posgxr
    color= pix[posdxr,posbyr]
    while(color[0]==221 and color[1]==0 and color[2]==0 and posdxr+pas<width):
        posdxr=posdxr+pas
        color= pix[posdxr,posbyr]
    posdxr=posdxr-pas
    ...
    while(zoneImageTrouve==0):
        ...
        while(posgxi+1<posdxi):
            if(not (color[0]==221 and color[1]==0 and color[2]==0)):
                zoneImageTrouve=1 
                break
            posgxi=posgxi+1
            color= pix[posgxi,posyi] 
    ...
    while(not (color[0]==221 and color[1]==0 and color[2]==0)):
        poshyi=poshyi-1
        color= pix[posgxi,poshyi]
    poshyi=poshyi+1
